...
df <- df %>% mutate(`Als Pauschalbetrag spende ich ...€...7` = as.numeric(`Als Pauschalbetrag spende ich ...€...7`),
             `Als Pauschalbetrag spende ich ...€...8` = as.numeric(`Als Pauschalbetrag spende ich ...€...8`),
             `Als Pauschalbetrag bei einem erfolgreichen Finish spende ich ...€` = as.numeric(`Als Pauschalbetrag bei einem erfolgreichen Finish spende ich ...€`),
             `Bei einem erfolgreichen Finish werde ich den Betrag auf ...€ aufstocken.` = as.numeric(`Bei einem erfolgreichen Finish werde ich den Betrag auf ...€ aufstocken.`))

sum_pauschalbetrag <- sum(df$`Als Pauschalbetrag spende ich ...€...7`, df$`Als Pauschalbetrag spende ich ...€...8`, na.rm = TRUE)

sum_finish <- sum(df$`Als Pauschalbetrag spende ich ...€...7`, df$`Als Pauschalbetrag bei einem erfolgreichen Finish spende ich ...€`, df$`Bei einem erfolgreichen Finish werde ich den Betrag auf ...€ aufstocken.`, na.rm = TRUE)
...
<b> Als Pauschalbetrag wurden bisher `r sum_pauschalbetrag` Euro gespendet

Bei einem erfolgreichen Finish kommen insgesammt `r sum_finish` Euro zusammen. </b>
...
# Das Projekt
Mein Ziel ist es aus eigenem Antrieb, self-supported$^1$ & schnellstmöglich vom tiefsten Punkt Deutschlands zum Höchsten zu gelangen. Anders gesagt: von Neuendorf-Sachsenbande (nördlich von Hamburg) auf die Zugspitze. Die gut 900 Kilometer (mit 7.200 Höhenmetern) lange Radstrecke führt mich durch 5 Bundesländer und endet an der Reintalangerhütte im Partnachtal bei Garmisch-Patenkirchen. Von dort trennen mich noch 6 Kilometer (mit 1.500 Höhenmetern) von Deutschlands höchsten Gipfel.

<aside> $^1$ self-supported heißt dabei, ohne fremde Hilfe. Alles was ich zum Erreichen des Ziels benötige werde ich von Anfang an mitnehmen. Unterwegs werde ich mich selbst versorgen. 
</aside>

### Meine Motivation
Ich bin auf das Schulprojekt und den Verein "Mon Devoir" auf einer Reise in den Togo nach dem Abitur/Matura gestoßen. Mich begeistert dabei besonders das freiwillige Engagement, mit dem sich Unterstützerinnen und Unterstützer engagieren. Durch den regelmäßgien Kontakt zum Vorstand, sowie aktiven Mitgliedern im Verein, vertraue ich darauf, dass das gespendete Geld zu in voller Höhe dort eingesetzt wird, wo es verwendet werden soll.
...
# Interesse geweckt?
Ich freue mich über jede Form der Unterstützung und möchte mich jetzt schonmal für dein Interesse bedanken. Falls du noch offene Fragen hast, melde dich gerne bei mir via [E-Mail](mailto:soeren@schwabbauer.de) Für interessierte Spender würde ich eine Whatsappgruppe erstellen. Dort werde ich Updates von Unterwegs, sowie dem Spendenstand teilen.

Wer noch mehr Informationen über die Schule oder den Verein möchte, kann sich gerne [hier](https://www.mon-devoir.de/) auf der Homepage etwas umschauen.
...
<i>Das Ausstellen einer Spendenbescheinigung ist möglich</i>


<b> Um einen Überblick zu bekommen würde ich mich freuen, wenn du dieses Formular noch kurz ausfüllen kannst. Ist natürlich völlig unverbindlich und kein Muss. Ich freue mich auch über anonyme Spenden!! </b>

<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd2w_MdyuJ03ciN__Pcdi56HoCn0U001RJt3WnPXLWP80Teew/viewform?embedded=true" width="640" height="995" frameborder="0" marginheight="0" marginwidth="0">Wird geladen…</iframe>
